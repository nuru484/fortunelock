        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              person. Lock in and protect your fortune with unmatched
            ...
            >
              <Link href="/signup">
                <Button
                  variant="hero"
                  size="xl"
                  className="group shadow-gold hover:shadow-gold/50 transition-all duration-300 hover:cursor-pointer"
                >
                  Create Account
              ...
              <Button
                ...
                size="xl"
                className="shadow-gold hover:shadow-gold/50 transition-all duration-300 hover:cursor-pointer"
