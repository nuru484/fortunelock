        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              surprises. Start securing your wealth today with our competitive
              rates.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              ...
              >
                ...
                {/* Popular Badge - Now positioned at the top */}
                {plan.popular && (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-gold text-navy font-bold px-6 py-2 rounded-full text-sm shadow-gold border border-gold/30 backdrop-blur-sm z-20"
                  >
                    MOST POPULAR
                  </motion.div>
                )}
                ...
                <div className="relative z-10">
                  {plan.price === "Custom" ? (
                    <Button
                      ...
                      size="lg"
                      className="w-full shadow-gold hover:shadow-gold/50 cursor-pointer"
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/signup">
                    <Button
                      variant="hero"
                      size="lg"
                      className="shadow-gold hover:shadow-gold/50 cursor-pointer"
                    >
                      Create Account
                    </Button>
                  </Link>
